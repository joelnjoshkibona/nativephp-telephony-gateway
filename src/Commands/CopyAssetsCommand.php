...
namespace Blutrixx\NativephpTelephonyGateway\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for TelephonyGateway plugin.
 *
...
{
    protected $signature = 'nativephp:telephony-gateway:copy-assets';

    protected $description = 'Copy assets for TelephonyGateway plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for TelephonyGateway');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for TelephonyGateway');
    }
}